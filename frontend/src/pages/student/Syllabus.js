...
function Syllabus() {
  ...
  const internalSillabi = data?.syllabi.data.filter((syllabus) => syllabus.attributes.isinternal);
  const externalSillabi = data?.syllabi.data.filter((syllabus) => !syllabus.attributes.isinternal);
