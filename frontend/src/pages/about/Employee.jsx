...
import { Container, Paper, Grid, Box, Typography, Link } from '@material-ui/core';
...
function Employee({ params }) {
  ...
  return (
    <>
      <Helmet>
        <title>{employee.fullname} | МПУіК</title>
      </Helmet>
      <TopWaves />
            ...
            <Box clone order={{ xs: 2, md: 1 }}>
              <Grid item xs={12} md={8} lg={7}>
                ...
                {employee.academiclevel && (
                  <Typography variant="subtitle1" paragraph className={classes.nomargin}>
                ...
                {employee.sefleducation && (
                  <Typography variant="subtitle1" paragraph className={classes.marginTop}>
                    <b>
                      <PageLink
                        title={'Стажування, підвищення кваліфікації, самоосвіта'}
                ...
                {employee.awards && (
                  <Typography variant="subtitle1" paragraph className={classes.nomargin}>
                    <b>
                      <PageLink title={'Відзнаки, подяки'} link={employee.awards} target="_blank" />
                    </b>
                  </Typography>
                )}
                  ...
                  <>
                    ...
                    <ol className={classes.list}>
                      {employee.publications.map((p) => (
                        <Typography key={p.id} variant="body1" align="justify" component="li">
                          {p.link ? <PageLink title={p.title} link={p.link} /> : p.title}
                        </Typography>
                      ))}
                    </ol>
                  </>
            ...
            <Box clone order={{ xs: 1, md: 2 }}>
              <Grid item xs={12} md={4} lg={4}>
                <img
                  ...
                  alt={employee.photo.data?.attributes.alternativeText ?? 'Default Photo'}
                ...
                {employee.email && (
                  <div className={classes.subitem}>
                    ...
                    <Typography variant="body1">
                      <Link className={classes.link} component={Obfuscate} email={employee.email} />
                    </Typography>
                  </div>
                )}
