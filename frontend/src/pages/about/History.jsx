...
function History() {
  ...
  const article = history?.content.find((content) => content.__typename === contentType.article);
  const gallery = history?.content.find((content) => content.__typename === contentType.gallery);
  ...
  return (
    <>
      ...
      <Container className="main-container" fixed>
        <Grid container component="section" alignContent="center" justify="center">
